...
export default function DevilsPage() {
  ...
  const teamNews = [
    {
      title: "Hughes Brothers Domination",
      summary: "Jack and Luke Hughes leading Devils' youth movement.",
      timestamp: "1 hour ago",
      category: "Player Performance"
    },
    {
      title: "Playoff Push Continues",
      summary: "New Jersey fighting for postseason position in competitive Metropolitan Division.",
      timestamp: "4 hours ago",
      category: "Playoffs"
    },
    {
      title: "Goaltending Stability",
      summary: "Jake Allen providing veteran presence in net.",
      timestamp: "1 day ago",
  ...
  const trendingTopics = [
    { title: "Hughes Brothers Future", replies: 456, trend: "hot" },
    { title: "Playoff Race Discussion", replies: 334, trend: "up" },
    { title: "Goaltending Situation", replies: 267, trend: "up" }
  ]
  ...
  const playerUpdates = [
    {
      ...
      position: "C",
      status: "Healthy",
      update: "Dynamic center leading team in scoring",
      trend: "up"
    },
    {
      name: "Luke Hughes",
      position: "D",
      status: "Healthy",
      update: "Rookie defenseman showing offensive upside",
      trend: "up"
    },
    {
      name: "Jesper Bratt",
      position: "RW",
      status: "Healthy",
      update: "Skilled winger providing consistent production",
      trend: "stable"
    }
  ]
    ...
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center">
            <div className="flex items-center justify-center mb-4">
              <img
                src="https://a.espncdn.com/i/teamlogos/nhl/500/njd.png"
                alt="New Jersey Devils"
                className="w-20 h-20 mr-4"
              />
              <div>
                <h1 className="text-4xl font-bold text-white mb-2">
                  New Jersey Devils Fan Hub
                </h1>
                <p className="text-red-100">
                  Connect with Devils Nation • Share insights • Build your reputation
                </p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                <h2 className="text-2xl font-bold mb-6 text-red-600">📰 Latest Devils News</h2>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">30-17-6</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Division:</span>
                    <span className="font-semibold">2nd Metropolitan</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">3 (2003)</span>
                  </div>
                </div>
              </div>
              ...
              {/* Community Stats */}
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-lg font-semibold mb-4 text-red-600">👥 Devils Nation</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
        ...
        {activeTab === 'discussions' && (
          <DiscussionForum sport="nhl" team="New Jersey Devils" />
        )}

        {activeTab === 'qa' && (
          <QAComponent sport="nhl" team="New Jersey Devils" />
        )}

        {activeTab === 'quizzes' && (
          <QuizComponent sport="nhl" team="New Jersey Devils" />
        )}

        {activeTab === 'chat' && (
          <LiveChat sport="nhl" team="New Jersey Devils" />
        )}

        {activeTab === 'reputation' && currentUser && (
          <ReputationSystem userId={currentUser.id} sport="nhl" team="New Jersey Devils" />
        )}
      </div>
