...
export default function CapitalsPage() {
  ...
  const teamNews = [
    {
      ...
      summary: "Alex Ovechkin sits at 853 goals, just 41 away from Gretzky's all-time record of 894.",
      timestamp: "1 hour ago",
      category: "History Watch"
    },
    {
      title: "Playoff Push Continues",
      summary: "Capitals fighting for postseason position in competitive Metropolitan Division.",
      timestamp: "4 hours ago",
      category: "Playoffs"
    },
    {
      title: "Lindgren's Goaltending",
      summary: "Charlie Lindgren providing stability between the pipes during crucial stretch.",
      timestamp: "1 day ago",
  ...
  const trendingTopics = [
    { title: "Ovechkin Goal Watch", replies: 567, trend: "hot" },
    { title: "Playoff Race Discussion", replies: 345, trend: "up" },
    { title: "Metropolitan Division Battle", replies: 234, trend: "up" }
  ]
  ...
  const playerUpdates = [
    {
      ...
      position: "LW",
      status: "Healthy",
      update: "Legendary goal-scorer chasing Gretzky's all-time record",
      trend: "up"
    },
    {
      name: "Dylan Strome",
      position: "C",
      status: "Healthy",
      update: "Center providing consistent offensive production",
      trend: "stable"
    },
    {
      ...
      position: "G",
      status: "Healthy",
      update: "Goaltender providing stability in net",
      trend: "up"
    }
  ]
    ...
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center">
            <div className="flex items-center justify-center mb-4">
              <img
                src="https://a.espncdn.com/i/teamlogos/nhl/500/wsh.png"
                alt="Washington Capitals"
                className="w-20 h-20 mr-4"
              />
              <div>
                <h1 className="text-4xl font-bold text-white mb-2">
                  Washington Capitals Fan Hub
                </h1>
                <p className="text-red-100">
                  Connect with Caps Nation • Share insights • Build your reputation
                </p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                <h2 className="text-2xl font-bold mb-6 text-red-600">📰 Latest Capitals News</h2>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">1 (2018)</span>
                  </div>
                </div>
              </div>
              ...
              {/* Community Stats */}
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-lg font-semibold mb-4 text-red-600">👥 Caps Nation</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
        ...
        {activeTab === 'discussions' && (
          <DiscussionForum sport="nhl" team="Washington Capitals" />
        )}

        {activeTab === 'qa' && (
          <QAComponent sport="nhl" team="Washington Capitals" />
        )}

        {activeTab === 'quizzes' && (
          <QuizComponent sport="nhl" team="Washington Capitals" />
        )}

        {activeTab === 'chat' && (
          <LiveChat sport="nhl" team="Washington Capitals" />
        )}

        {activeTab === 'reputation' && currentUser && (
          <ReputationSystem userId={currentUser.id} sport="nhl" team="Washington Capitals" />
        )}
      </div>
