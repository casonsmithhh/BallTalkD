...
export default function DucksPage() {
  ...
  const teamNews = [
    {
      title: "Ducks Youth Movement Continues",
      summary: "Young core of Zegras, McTavish, and Mintyukov showing promise in development.",
      timestamp: "2 hours ago",
      category: "Player Development"
    },
    {
      title: "Gibson's Goaltending Excellence",
      summary: "John Gibson continues to be bright spot despite team struggles.",
      timestamp: "5 hours ago",
      category: "Player Performance"
    },
    {
      title: "Trade Deadline Sellers",
      summary: "Anaheim expected to move veterans for future assets.",
      timestamp: "1 day ago",
  ...
  const trendingTopics = [
    { title: "Zegras Highlight Reels", replies: 234, trend: "hot" },
    { title: "Rebuild Timeline", replies: 189, trend: "up" },
    { title: "Prospect Development", replies: 156, trend: "up" }
  ]
  ...
  const playerUpdates = [
    {
      ...
      position: "C",
      status: "Healthy",
      update: "Creative playmaker leading team in assists",
      trend: "up"
    },
    {
      name: "Mason McTavish",
      position: "C",
      status: "Healthy",
      update: "Power forward showing two-way improvement",
      trend: "up"
    },
    {
      name: "John Gibson",
      position: "G",
      status: "Healthy",
      update: "Veteran goalie anchoring young team",
      trend: "stable"
    }
  ]
    ...
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center">
            <div className="flex items-center justify-center mb-4">
              <img
                src="https://a.espncdn.com/i/teamlogos/nhl/500/ana.png"
                alt="Anaheim Ducks"
                className="w-20 h-20 mr-4"
              />
              <div>
                <h1 className="text-4xl font-bold text-white mb-2">
                  Anaheim Ducks Fan Hub
                </h1>
                <p className="text-orange-100">
                  Connect with Ducks Flock • Share insights • Build your reputation
                </p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                <h2 className="text-2xl font-bold mb-6 text-orange-600">📰 Latest Ducks News</h2>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">18-28-6</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">1 (2007)</span>
                  </div>
                </div>
              </div>
              ...
              {/* Community Stats */}
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-lg font-semibold mb-4 text-orange-600">👥 Ducks Flock</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
        ...
        {activeTab === 'discussions' && (
          <DiscussionForum sport="nhl" team="Anaheim Ducks" />
        )}

        {activeTab === 'qa' && (
          <QAComponent sport="nhl" team="Anaheim Ducks" />
        )}

        {activeTab === 'quizzes' && (
          <QuizComponent sport="nhl" team="Anaheim Ducks" />
        )}

        {activeTab === 'chat' && (
          <LiveChat sport="nhl" team="Anaheim Ducks" />
        )}

        {activeTab === 'reputation' && currentUser && (
          <ReputationSystem userId={currentUser.id} sport="nhl" team="Anaheim Ducks" />
        )}
      </div>
