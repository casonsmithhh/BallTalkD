...
export default function RangersPage() {
  ...
  const teamNews = [
    {
      title: "Panarin's MVP Campaign",
      summary: "Artemi Panarin putting up career numbers in Hart Trophy conversation.",
      timestamp: "1 hour ago",
      category: "Awards Watch"
    },
    {
      title: "Shesterkin's Elite Play",
      summary: "Igor Shesterkin continuing to be backbone of Rangers' success.",
      timestamp: "4 hours ago",
      category: "Goaltending"
    },
    {
      title: "Metropolitan Division Lead",
      summary: "New York maintaining top position in competitive division.",
      timestamp: "1 day ago",
      category: "Standings"
    }
  ]
  ...
  const trendingTopics = [
    { title: "Panarin MVP Case", replies: 567, trend: "hot" },
    { title: "Cup Contender Status", replies: 456, trend: "up" },
  ...
  const playerUpdates = [
    {
      ...
      position: "LW",
      status: "Healthy",
      update: "Elite winger leading team with career-best production",
      trend: "up"
    },
    {
    ...
    },
    {
      ...
      position: "C",
      status: "Healthy",
      update: "Top-line center providing two-way excellence",
      trend: "stable"
    }
  ]
    ...
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center">
            <div className="flex items-center justify-center mb-4">
              <img
                src="https://a.espncdn.com/i/teamlogos/nhl/500/nyr.png"
                alt="New York Rangers"
                className="w-20 h-20 mr-4"
              />
              <div>
                <h1 className="text-4xl font-bold text-white mb-2">
                  New York Rangers Fan Hub
                </h1>
                <p className="text-blue-100">
                  Connect with Blueshirt Faithful • Share insights • Build your reputation
                </p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                <h2 className="text-2xl font-bold mb-6 text-blue-600">📰 Latest Rangers News</h2>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">29-18-5</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Division:</span>
                    <span className="font-semibold">3rd Metropolitan</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">4 (1994)</span>
                  </div>
                </div>
              </div>
              ...
              {/* Community Stats */}
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-lg font-semibold mb-4 text-blue-600">👥 Blueshirt Faithful</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
                    <span className="text-gray-600">Active Fans:</span>
                    <span className="font-semibold">10,847</span>
                  </div>
                  <div className="flex justify-between">
        ...
        {activeTab === 'discussions' && (
          <DiscussionForum sport="nhl" team="New York Rangers" />
        )}

        {activeTab === 'qa' && (
          <QAComponent sport="nhl" team="New York Rangers" />
        )}

        {activeTab === 'quizzes' && (
          <QuizComponent sport="nhl" team="New York Rangers" />
        )}

        {activeTab === 'chat' && (
          <LiveChat sport="nhl" team="New York Rangers" />
        )}

        {activeTab === 'reputation' && currentUser && (
          <ReputationSystem userId={currentUser.id} sport="nhl" team="New York Rangers" />
        )}
      </div>
