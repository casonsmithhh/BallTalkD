...
export default function OilersPage() {
  ...
  const teamNews = [
    {
      title: "McDavid and Draisaitl Dominance",
      summary: "Superstar duo continuing to lead Oilers' offensive attack.",
      timestamp: "1 hour ago",
      category: "Player Performance"
    },
    {
      title: "Cup Contender Status",
      summary: "Edmonton positioning as serious Stanley Cup contender.",
      timestamp: "3 hours ago",
      category: "Team Analysis"
    },
    {
      title: "Goaltending Stability",
      summary: "Stuart Skinner providing consistent play between the pipes.",
  ...
  const trendingTopics = [
    { title: "McDavid MVP Case", replies: 567, trend: "hot" },
    { title: "Cup Window Discussion", replies: 456, trend: "up" },
    { title: "Playoff Matchups", replies: 345, trend: "up" }
  ]
  ...
  const playerUpdates = [
    {
      ...
      position: "C",
      status: "Healthy",
      update: "Generational talent leading league in scoring",
      trend: "up"
    },
    {
      name: "Leon Draisaitl",
      position: "C",
      status: "Healthy",
      update: "Elite center providing consistent offensive production",
      trend: "up"
    },
    {
      name: "Stuart Skinner",
      position: "G",
      status: "Healthy",
      update: "Young goaltender establishing himself as starter",
      trend: "stable"
    }
  ]
    ...
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center">
            <div className="flex items-center justify-center mb-4">
              <img
                src="https://a.espncdn.com/i/teamlogos/nhl/500/edm.png"
                alt="Edmonton Oilers"
                className="w-20 h-20 mr-4"
              />
              <div>
                <h1 className="text-4xl font-bold text-white mb-2">
                  Edmonton Oilers Fan Hub
                </h1>
                <p className="text-blue-100">
                  Connect with Oil Country • Share insights • Build your reputation
                </p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                <h2 className="text-2xl font-bold mb-6 text-blue-600">📰 Latest Oilers News</h2>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">5 (1990)</span>
                  </div>
                </div>
              </div>
              ...
              {/* Community Stats */}
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-lg font-semibold mb-4 text-blue-600">👥 Oil Country</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">3,134</span>
                  </div>
                  <div className="flex justify-between">
        ...
        {activeTab === 'discussions' && (
          <DiscussionForum sport="nhl" team="Edmonton Oilers" />
        )}

        {activeTab === 'qa' && (
          <QAComponent sport="nhl" team="Edmonton Oilers" />
        )}

        {activeTab === 'quizzes' && (
          <QuizComponent sport="nhl" team="Edmonton Oilers" />
        )}

        {activeTab === 'chat' && (
          <LiveChat sport="nhl" team="Edmonton Oilers" />
        )}

        {activeTab === 'reputation' && currentUser && (
          <ReputationSystem userId={currentUser.id} sport="nhl" team="Edmonton Oilers" />
        )}
      </div>
