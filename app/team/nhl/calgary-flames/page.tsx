...
export default function FlamesPage() {
  ...
  const teamNews = [
    {
      title: "Flames Playoff Push",
      summary: "Calgary fighting for wildcard spot in competitive Western Conference.",
      timestamp: "2 hours ago",
      category: "Playoffs"
    },
    {
      title: "Huberdeau Finding Form",
      summary: "Star forward showing signs of returning to elite production levels.",
      timestamp: "5 hours ago",
      category: "Player Performance"
    },
    {
      title: "Markstrom's Stellar Play",
      summary: "Veteran goaltender providing stability between the pipes.",
      timestamp: "1 day ago",
  ...
  const trendingTopics = [
    { title: "Playoff Race Discussion", replies: 389, trend: "hot" },
    { title: "Huberdeau Bounce Back", replies: 267, trend: "up" },
    { title: "Trade Deadline Moves", replies: 198, trend: "up" }
  ]
  ...
  const playerUpdates = [
    {
      ...
      position: "LW",
      status: "Healthy",
      update: "Elite playmaker finding chemistry with linemates",
      trend: "up"
    },
    {
      ...
      position: "G",
      status: "Healthy",
      update: "Veteran goalie providing consistent performances",
      trend: "stable"
    },
    {
      name: "Elias Lindholm",
      position: "C",
      status: "Healthy",
      update: "Two-way center anchoring top line",
      trend: "stable"
    }
  ]
    ...
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center">
            <div className="flex items-center justify-center mb-4">
              <img
                src="https://a.espncdn.com/i/teamlogos/nhl/500/cgy.png"
                alt="Calgary Flames"
                className="w-20 h-20 mr-4"
              />
              <div>
                <h1 className="text-4xl font-bold text-white mb-2">
                  Calgary Flames Fan Hub
                </h1>
                <p className="text-red-100">
                  Connect with Flames Nation • Share insights • Build your reputation
                </p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                <h2 className="text-2xl font-bold mb-6 text-red-600">📰 Latest Flames News</h2>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">7th Pacific</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">1 (1989)</span>
                  </div>
                </div>
              </div>
              ...
              {/* Community Stats */}
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-lg font-semibold mb-4 text-red-600">👥 Flames Nation</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
        ...
        {activeTab === 'discussions' && (
          <DiscussionForum sport="nhl" team="Calgary Flames" />
        )}

        {activeTab === 'qa' && (
          <QAComponent sport="nhl" team="Calgary Flames" />
        )}

        {activeTab === 'quizzes' && (
          <QuizComponent sport="nhl" team="Calgary Flames" />
        )}

        {activeTab === 'chat' && (
          <LiveChat sport="nhl" team="Calgary Flames" />
        )}

        {activeTab === 'reputation' && currentUser && (
          <ReputationSystem userId={currentUser.id} sport="nhl" team="Calgary Flames" />
        )}
      </div>
