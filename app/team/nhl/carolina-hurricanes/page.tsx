...
export default function HurricanesPage() {
  ...
  const teamNews = [
    {
      title: "Hurricanes Storm Warning",
      summary: "Carolina's high-tempo system creating havoc for opponents in Metropolitan Division.",
      timestamp: "1 hour ago",
      category: "Team Performance"
    },
    {
      title: "Aho's Elite Season",
      summary: "Sebastian Aho continuing to be offensive catalyst for Hurricanes.",
      timestamp: "4 hours ago",
      category: "Player Performance"
    },
    {
      title: "Andersen's Return",
      summary: "Frederik Andersen working back from injury to solidify goaltending.",
      timestamp: "1 day ago",
  ...
  const trendingTopics = [
    { title: "Rod Brind'Amour System", replies: 445, trend: "hot" },
    { title: "Aho MVP Candidacy", replies: 334, trend: "up" },
  ...
  const playerUpdates = [
    {
      ...
      position: "C",
      status: "Healthy",
      update: "Elite center leading team in scoring and playmaking",
      trend: "up"
    },
    {
      ...
      position: "RW",
      status: "Healthy",
      update: "Dynamic winger providing goal-scoring punch",
      trend: "up"
    },
    {
      ...
      position: "G",
      status: "Day-to-Day",
      update: "Veteran goalie working back from injury",
      trend: "stable"
    }
  ]
    ...
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center">
            <div className="flex items-center justify-center mb-4">
              <img
                src="https://a.espncdn.com/i/teamlogos/nhl/500/car.png"
                alt="Carolina Hurricanes"
                className="w-20 h-20 mr-4"
              />
              <div>
                <h1 className="text-4xl font-bold text-white mb-2">
                  Carolina Hurricanes Fan Hub
                </h1>
                <p className="text-red-100">
                  Connect with Caniacs • Share insights • Build your reputation
                </p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                <h2 className="text-2xl font-bold mb-6 text-red-600">📰 Latest Hurricanes News</h2>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">6th Metropolitan</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">1 (2006)</span>
                  </div>
                </div>
              </div>
              ...
              {/* Community Stats */}
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-lg font-semibold mb-4 text-red-600">👥 Caniacs</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
                    <span className="text-gray-600">Active Fans:</span>
                    <span className="font-semibold">5,947</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Discussions:</span>
                    <span className="font-semibold">1,634</span>
                  </div>
                  <div className="flex justify-between">
        ...
        {activeTab === 'discussions' && (
          <DiscussionForum sport="nhl" team="Carolina Hurricanes" />
        )}

        {activeTab === 'qa' && (
          <QAComponent sport="nhl" team="Carolina Hurricanes" />
        )}

        {activeTab === 'quizzes' && (
          <QuizComponent sport="nhl" team="Carolina Hurricanes" />
        )}

        {activeTab === 'chat' && (
          <LiveChat sport="nhl" team="Carolina Hurricanes" />
        )}

        {activeTab === 'reputation' && currentUser && (
          <ReputationSystem userId={currentUser.id} sport="nhl" team="Carolina Hurricanes" />
        )}
      </div>
