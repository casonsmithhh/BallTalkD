...
export default function AvalanchePage() {
  ...
  const teamNews = [
    {
      title: "MacKinnon's Hart Trophy Push",
      summary: "Nathan MacKinnon putting up MVP-caliber numbers in pursuit of Hart Trophy.",
      timestamp: "1 hour ago",
      category: "Awards Watch"
    },
    {
      title: "Makar's Elite Defense",
      summary: "Cale Makar continuing to redefine the modern defenseman position.",
      timestamp: "3 hours ago",
      category: "Player Performance"
    },
    {
      title: "Championship Window",
      summary: "Avalanche looking to capitalize on championship core while healthy.",
  ...
  const trendingTopics = [
    { title: "MacKinnon MVP Case", replies: 456, trend: "hot" },
    { title: "Makar Norris Defense", replies: 334, trend: "up" },
    { title: "Cup Window Discussion", replies: 267, trend: "up" }
  ]
  ...
  const playerUpdates = [
    {
      ...
      position: "C",
      status: "Healthy",
      update: "Elite center putting up Hart Trophy-worthy numbers",
      trend: "up"
    },
    {
      name: "Cale Makar",
      position: "D",
      status: "Healthy",
      update: "Dynamic defenseman leading from the blue line",
      trend: "up"
    },
    {
      name: "Mikko Rantanen",
      position: "RW",
      status: "Healthy",
      update: "Consistent goal scorer providing offensive depth",
      trend: "stable"
    }
  ]
    ...
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center">
            <div className="flex items-center justify-center mb-4">
              <img
                src="https://a.espncdn.com/i/teamlogos/nhl/500/col.png"
                alt="Colorado Avalanche"
                className="w-20 h-20 mr-4"
              />
              <div>
                <h1 className="text-4xl font-bold text-white mb-2">
                  Colorado Avalanche Fan Hub
                </h1>
                <p className="text-blue-100">
                  Connect with Avs Faithful • Share insights • Build your reputation
                </p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                <h2 className="text-2xl font-bold mb-6 text-blue-800">📰 Latest Avalanche News</h2>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">29-19-4</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Division:</span>
                    <span className="font-semibold">4th Central</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">3 (2022)</span>
                  </div>
                </div>
              </div>
              ...
              {/* Community Stats */}
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-lg font-semibold mb-4 text-blue-800">👥 Avs Faithful</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
                    <span className="text-gray-600">Active Fans:</span>
                    <span className="font-semibold">9,247</span>
                  </div>
                  <div className="flex justify-between">
        ...
        {activeTab === 'discussions' && (
          <DiscussionForum sport="nhl" team="Colorado Avalanche" />
        )}

        {activeTab === 'qa' && (
          <QAComponent sport="nhl" team="Colorado Avalanche" />
        )}

        {activeTab === 'quizzes' && (
          <QuizComponent sport="nhl" team="Colorado Avalanche" />
        )}

        {activeTab === 'chat' && (
          <LiveChat sport="nhl" team="Colorado Avalanche" />
        )}

        {activeTab === 'reputation' && currentUser && (
          <ReputationSystem userId={currentUser.id} sport="nhl" team="Colorado Avalanche" />
        )}
      </div>
