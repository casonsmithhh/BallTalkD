...
export default function MapleLeafsPage() {
  ...
  const teamNews = [
    {
      title: "Matthews' Scoring Pace",
      summary: "Auston Matthews on historic goal-scoring pace in pursuit of 70-goal season.",
      timestamp: "1 hour ago",
      category: "Player Performance"
    },
    {
      title: "Playoff Positioning",
      summary: "Toronto battling for home ice advantage in competitive Atlantic Division.",
      timestamp: "4 hours ago",
      category: "Standings"
    },
    {
      title: "Woll's Goaltending Development",
      summary: "Joseph Woll showing promise as potential playoff starter.",
      timestamp: "1 day ago",
  ...
  const trendingTopics = [
    { title: "Matthews 70-Goal Watch", replies: 567, trend: "hot" },
    { title: "Playoff Matchup Scenarios", replies: 456, trend: "up" },
    { title: "Goaltending Situation", replies: 345, trend: "up" }
  ]
  ...
  const playerUpdates = [
    {
      ...
      position: "C",
      status: "Healthy",
      update: "Elite goal-scorer on historic pace",
      trend: "up"
    },
    {
      name: "Mitch Marner",
      position: "RW",
      status: "Healthy",
      update: "Playmaking winger providing consistent offense",
      trend: "stable"
    },
    {
      ...
      position: "RW",
      status: "Healthy",
      update: "Dynamic winger having career-best season",
      trend: "up"
    }
  ]
    ...
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center">
            <div className="flex items-center justify-center mb-4">
              <img
                src="https://a.espncdn.com/i/teamlogos/nhl/500/tor.png"
                alt="Toronto Maple Leafs"
                className="w-20 h-20 mr-4"
              />
              <div>
                <h1 className="text-4xl font-bold text-white mb-2">
                  Toronto Maple Leafs Fan Hub
                </h1>
                <p className="text-blue-100">
                  Connect with Leafs Nation • Share insights • Build your reputation
                </p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                <h2 className="text-2xl font-bold mb-6 text-blue-700">📰 Latest Maple Leafs News</h2>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">28-19-5</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">13 (1967)</span>
                  </div>
                </div>
              </div>
              ...
              {/* Community Stats */}
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-lg font-semibold mb-4 text-blue-700">👥 Leafs Nation</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
        ...
        {activeTab === 'discussions' && (
          <DiscussionForum sport="nhl" team="Toronto Maple Leafs" />
        )}

        {activeTab === 'qa' && (
          <QAComponent sport="nhl" team="Toronto Maple Leafs" />
        )}

        {activeTab === 'quizzes' && (
          <QuizComponent sport="nhl" team="Toronto Maple Leafs" />
        )}

        {activeTab === 'chat' && (
          <LiveChat sport="nhl" team="Toronto Maple Leafs" />
        )}

        {activeTab === 'reputation' && currentUser && (
          <ReputationSystem userId={currentUser.id} sport="nhl" team="Toronto Maple Leafs" />
        )}
      </div>
