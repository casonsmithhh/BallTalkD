...
export default function CanucksPage() {
  ...
  const teamNews = [
    {
      title: "Canucks Lead Pacific Division",
      summary: "Vancouver's surprising season continues with strong position atop division.",
      timestamp: "2 hours ago",
      category: "Standings"
    },
    {
      title: "Pettersson's Elite Season",
      summary: "Elias Pettersson putting up career numbers in breakout campaign.",
      timestamp: "5 hours ago",
      category: "Player Performance"
    },
    {
      title: "Demko's Vezina Campaign",
      summary: "Thatcher Demko making case for top goaltender award with stellar play.",
      timestamp: "1 day ago",
  ...
  const trendingTopics = [
    ...
    { title: "Demko Vezina Case", replies: 334, trend: "up" },
    { title: "Pacific Division Lead", replies: 267, trend: "up" }
  ]
  ...
  const playerUpdates = [
    {
      ...
      position: "C",
      status: "Healthy",
      update: "Elite center leading team in scoring",
      trend: "up"
    },
    {
      name: "Quinn Hughes",
      position: "D",
      status: "Healthy",
      update: "Dynamic defenseman providing offense from blue line",
      trend: "up"
    },
    {
      name: "Thatcher Demko",
    ...
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center">
            <div className="flex items-center justify-center mb-4">
              <img
                src="https://a.espncdn.com/i/teamlogos/nhl/500/van.png"
                alt="Vancouver Canucks"
                className="w-20 h-20 mr-4"
              />
              <div>
                <h1 className="text-4xl font-bold text-white mb-2">
                  Vancouver Canucks Fan Hub
                </h1>
                <p className="text-blue-100">
                  Connect with Canucks Nation • Share insights • Build your reputation
                </p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                <h2 className="text-2xl font-bold mb-6 text-blue-600">📰 Latest Canucks News</h2>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">33-13-6</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Division:</span>
                    <span className="font-semibold">1st Pacific</span>
                  </div>
                  <div className="flex justify-between">
              ...
              {/* Community Stats */}
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-lg font-semibold mb-4 text-blue-600">👥 Canucks Nation</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
        ...
        {activeTab === 'discussions' && (
          <DiscussionForum sport="nhl" team="Vancouver Canucks" />
        )}

        {activeTab === 'qa' && (
          <QAComponent sport="nhl" team="Vancouver Canucks" />
        )}

        {activeTab === 'quizzes' && (
          <QuizComponent sport="nhl" team="Vancouver Canucks" />
        )}

        {activeTab === 'chat' && (
          <LiveChat sport="nhl" team="Vancouver Canucks" />
        )}

        {activeTab === 'reputation' && currentUser && (
          <ReputationSystem userId={currentUser.id} sport="nhl" team="Vancouver Canucks" />
        )}
      </div>
