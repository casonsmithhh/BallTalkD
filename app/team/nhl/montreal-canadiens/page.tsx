...
export default function CanadiensPage() {
  ...
  const teamNews = [
    {
      title: "Suzuki's Leadership Growth",
      summary: "Captain Nick Suzuki developing into cornerstone player for Canadiens.",
      timestamp: "2 hours ago",
      category: "Player Development"
    },
    {
      title: "Caufield's Scoring Touch",
      summary: "Cole Caufield continuing to be offensive catalyst for Montreal.",
      timestamp: "5 hours ago",
      category: "Player Performance"
    },
    {
      title: "Rebuild Progress Report",
      summary: "Canadiens' youth movement showing promise despite challenging season.",
      timestamp: "1 day ago",
      category: "Rebuild"
    }
  ]
  ...
  const trendingTopics = [
    { title: "Rebuild Timeline", replies: 456, trend: "hot" },
    { title: "Suzuki's Development", replies: 334, trend: "up" },
    { title: "Draft Lottery Odds", replies: 267, trend: "up" }
  ]
  ...
  const playerUpdates = [
    {
      ...
      position: "C",
      status: "Healthy",
      update: "Young captain leading team in scoring and leadership",
      trend: "up"
    },
    {
      name: "Cole Caufield",
      position: "RW",
      status: "Healthy",
      update: "Sniper providing consistent goal-scoring",
      trend: "up"
    },
    {
      name: "Kaiden Guhle",
    ...
    <div className="min-h-screen bg-gray-100">
            ...
            <div className="flex items-center justify-center mb-4">
              ...
              <div>
                <h1 className="text-4xl font-bold text-white mb-2">
                  Montreal Canadiens Fan Hub
                </h1>
                <p className="text-red-100">
                  Connect with Habs Nation • Share insights • Build your reputation
                </p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                <h2 className="text-2xl font-bold mb-6 text-red-600">📰 Latest Canadiens News</h2>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">21-23-8</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Division:</span>
                    <span className="font-semibold">7th Atlantic</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">24 (1993)</span>
                  </div>
                </div>
              </div>
              ...
              {/* Community Stats */}
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-lg font-semibold mb-4 text-red-600">👥 Habs Nation</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
        ...
        {activeTab === 'discussions' && (
          <DiscussionForum sport="nhl" team="Montreal Canadiens" />
        )}

        {activeTab === 'qa' && (
          <QAComponent sport="nhl" team="Montreal Canadiens" />
        )}

        {activeTab === 'quizzes' && (
          <QuizComponent sport="nhl" team="Montreal Canadiens" />
        )}

        {activeTab === 'chat' && (
          <LiveChat sport="nhl" team="Montreal Canadiens" />
        )}

        {activeTab === 'reputation' && currentUser && (
          <ReputationSystem userId={currentUser.id} sport="nhl" team="Montreal Canadiens" />
        )}
      </div>
