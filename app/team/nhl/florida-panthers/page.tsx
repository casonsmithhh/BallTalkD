...
export default function PanthersPage() {
  ...
  const teamNews = [
    {
      title: "Panthers Defending the Cup",
      summary: "Florida looking to repeat as Stanley Cup champions with core intact.",
      timestamp: "1 hour ago",
      category: "Championship"
    },
    {
      title: "Barkov's Selke Campaign",
      summary: "Captain Aleksander Barkov making case for another Selke Trophy.",
      timestamp: "4 hours ago",
      category: "Awards Watch"
    },
    {
      title: "Bobrovsky's Elite Play",
      summary: "Veteran goaltender continuing strong play after championship season.",
      timestamp: "1 day ago",
  ...
  const trendingTopics = [
    { title: "Cup Defense Strategy", replies: 567, trend: "hot" },
    { title: "Barkov Selke Case", replies: 456, trend: "up" },
    { title: "Atlantic Division Race", replies: 345, trend: "up" }
  ]
  ...
  const playerUpdates = [
    {
      ...
      position: "C",
      status: "Healthy",
      update: "Elite two-way center leading team in all situations",
      trend: "up"
    },
    {
      ...
      position: "LW",
      status: "Healthy",
      update: "Power forward providing scoring and physical presence",
      trend: "up"
    },
    {
      ...
      position: "G",
      status: "Healthy",
      update: "Veteran goalie maintaining championship form",
      trend: "stable"
    }
  ]
    ...
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center">
            <div className="flex items-center justify-center mb-4">
              <img
                src="https://a.espncdn.com/i/teamlogos/nhl/500/fla.png"
                alt="Florida Panthers"
                className="w-20 h-20 mr-4"
              />
              <div>
                <h1 className="text-4xl font-bold text-white mb-2">
                  Florida Panthers Fan Hub
                </h1>
                <p className="text-red-100">
                  Connect with Panther Nation • Share insights • Build your reputation
                </p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                <h2 className="text-2xl font-bold mb-6 text-red-600">📰 Latest Panthers News</h2>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">32-18-4</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Division:</span>
                    <span className="font-semibold">1st Atlantic</span>
                  </div>
                  <div className="flex justify-between">
              ...
              {/* Community Stats */}
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-lg font-semibold mb-4 text-red-600">👥 Panther Nation</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
        ...
        {activeTab === 'discussions' && (
          <DiscussionForum sport="nhl" team="Florida Panthers" />
        )}

        {activeTab === 'qa' && (
          <QAComponent sport="nhl" team="Florida Panthers" />
        )}

        {activeTab === 'quizzes' && (
          <QuizComponent sport="nhl" team="Florida Panthers" />
        )}

        {activeTab === 'chat' && (
          <LiveChat sport="nhl" team="Florida Panthers" />
        )}

        {activeTab === 'reputation' && currentUser && (
          <ReputationSystem userId={currentUser.id} sport="nhl" team="Florida Panthers" />
        )}
      </div>
