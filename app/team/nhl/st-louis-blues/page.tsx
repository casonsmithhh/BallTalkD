...
export default function BluesPage() {
  ...
  const teamNews = [
    {
      title: "Blues' Central Division Battle",
      summary: "St. Louis fighting for playoff position in competitive Central Division.",
      timestamp: "2 hours ago",
      category: "Standings"
    },
    {
      title: "Kyrou's Scoring Touch",
      summary: "Jordan Kyrou continuing to be offensive catalyst for Blues.",
      timestamp: "5 hours ago",
      category: "Player Performance"
    },
    {
      title: "Binnington's Goaltending",
      summary: "Jordan Binnington providing stability between the pipes.",
      timestamp: "1 day ago",
  ...
  const trendingTopics = [
    ...
    { title: "Kyrou's Development", replies: 267, trend: "up" },
  ...
  const playerUpdates = [
    ...
    },
    {
      ...
      position: "C",
      status: "Healthy",
      update: "Playmaking center providing consistent offense",
      trend: "up"
    },
    {
      ...
      position: "G",
      status: "Healthy",
      update: "Veteran goaltender providing stability in net",
      trend: "stable"
    }
  ]
    ...
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center">
            <div className="flex items-center justify-center mb-4">
              <img
                src="https://a.espncdn.com/i/teamlogos/nhl/500/stl.png"
                alt="St. Louis Blues"
                className="w-20 h-20 mr-4"
              />
              <div>
                <h1 className="text-4xl font-bold text-white mb-2">
                  St. Louis Blues Fan Hub
                </h1>
                <p className="text-blue-100">
                  Connect with Blues Nation • Share insights • Build your reputation
                </p>
              </div>
            </div>
            <div className="mt-4 flex justify-center space-x-2">
              ...
              <span className="bg-yellow-400 text-blue-700 text-sm px-3 py-1 rounded-full font-semibold">
                Central Division
              </span>
              <span className="bg-white text-blue-700 text-sm px-3 py-1 rounded-full font-semibold">
                25-21-6 Record
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                <h2 className="text-2xl font-bold mb-6 text-blue-700">📰 Latest Blues News</h2>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">7th Central</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">1 (2019)</span>
                  </div>
                </div>
              </div>
              ...
              {/* Community Stats */}
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-lg font-semibold mb-4 text-blue-700">👥 Blues Nation</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
        ...
        {activeTab === 'discussions' && (
          <DiscussionForum sport="nhl" team="St. Louis Blues" />
        )}

        {activeTab === 'qa' && (
          <QAComponent sport="nhl" team="St. Louis Blues" />
        )}

        {activeTab === 'quizzes' && (
          <QuizComponent sport="nhl" team="St. Louis Blues" />
        )}

        {activeTab === 'chat' && (
          <LiveChat sport="nhl" team="St. Louis Blues" />
        )}

        {activeTab === 'reputation' && currentUser && (
          <ReputationSystem userId={currentUser.id} sport="nhl" team="St. Louis Blues" />
        )}
      </div>
